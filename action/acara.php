...
<section class="content-wrapper">
    <div class="container">
        <br>
        <h5 class="text-dark">Acara</h5>
        
        <div class="card">
            <div class="card-body">
                <!-- <a style="font-size: small; background-image: linear-gradient(135deg, #FAB2FF 10%, #1904E5 100%);" href="acara_tambah.php" class="btn text-white">+ Tambah Data</a> -->
                <a style="font-size: small; background-color: #404040;" href="acara_tambah.php" class="btn text-white">+ Tambah Data</a>
                <br>		
                <br>		
                <table style="font-size: small;" id="example" class="display table table-bordered table-striped">
                    ...
                    while($d = mysqli_fetch_array($data)){
                        ...
                        <tbody>
                            <tr>
                                ...
                                <td class="text-center">
                                    <div class="row">
                                        <div class="col">
                                            <a style="font-size: 8px;" type="button" class="btn btn-success" data-toggle="modal" data-target="#exampleModal<?php echo $d['acara_id']; ?>" title="Detail">
                                                <i class="fa-solid fa-eye"></i>
                                            </a>

                                            <a style="font-size: 8px;" onclick="return konfirmasi()" href="acara_delete.php?acara_id=<?php echo $d['acara_id'];?>" class="btn btn-danger"><i class="fa fa-trash"></i></a>
                                        </div>
                                        <!-- <div class="col">
                        ...
                        <!-- Modal Detail Start-->
                        <div class="modal fade" id="exampleModal<?php echo $d['acara_id']; ?>" tabindex="-1" aria-labelledby="exampleModalLabel" aria-hidden="true">
