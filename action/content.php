...
<section class="content-wrapper">
    <div class="container">
        <br>
        <h5 class="text-dark">Content V1</h5>
            ...
            <div class="card-body">
                ...
                <table style="font-size: small;" id="example" class="display table table-bordered table-striped">
                    ...
                    while($d = mysqli_fetch_array($data)){
                        ...
                        <tbody>
                            <tr>
                                ...
                                <td class="text-center">
                                    <div class="row">
                                        <div class="col">
                                            <a style="font-size: 8px;" type="button" class="btn btn-success" data-toggle="modal" data-target="#exampleModal<?php echo $d['content_id']; ?>" title="Detail">
                        ...
                        <!-- Modal Detail Start-->
                        <div class="modal fade" id="exampleModal<?php echo $d['content_id']; ?>" tabindex="-1" aria-labelledby="exampleModalLabel" aria-hidden="true">
                            <div class="modal-dialog">
                                <!-- <div class="modal-content" style="background-image: linear-gradient(135deg, #FAB2FF 10%, #1904E5 100%);"> -->
                                <div class="modal-content">
                                    <div class="modal-header bg-dark">
                                        <h5 class="modal-title" id="exampleModalLabel">Detail Content V1</h5>
                                    ...
                                    <div class="modal-body">
                                        <div class="card">
                                            <div class="card-body">
                                                <img class="img-fluid rounded" src="gambar/<?php echo $d['foto'] ?>" width="240" height="240">
